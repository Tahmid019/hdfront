        ...
        {success ? (
          <div className="text-center py-6 fade-in">
            ...
            <p className="text-sm text-muted mb-6 leading-relaxed">
              Clinical registration request submitted successfully. Please check your inbox to confirm your email address.
            </p>
            <Link
              id="goto-login-btn"
              href="/login"
          ...
          <>
            ...
            <p className="text-xs text-muted mb-6">
              Register to access the HemoSync hemodialysis dashboards.
            </p>

            {error && (
              <div className="mb-4 rounded-xl bg-critical/10 p-3 text-xs font-semibold text-critical animate-shake border border-critical/15">
                {error}
              </div>
            )}
